...
public class _05_VariableNaming {
    public static void main(String[] args) {
        // 변수 이름 짓는 법
        // 1. 저장할 값에 어울리는 이름
        // 2. 밑즐(-), 문자(abc), 숫자(123) 사용 가능 (공백 사용 불가)
        // 3. 밑줄 또는 문자로 시작 가능
        ...
        // string firstName ="두슬";// 이름 String
        // lastName = "최": / 성 string dateofeirth = "2001-12-31" // 생년월일
        // string residentialAddress ="무슨 호텔";// 체류지
        // string purposeofvisit= “관광";// 입국목적 String
        // flightNo = "KE657"; // 항공 편명 string_flightNo = "KE657"; // 밑줄 시작
